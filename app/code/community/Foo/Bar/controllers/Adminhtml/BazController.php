<?php
class Foo_Bar_Adminhtml_BazController
    ...
    public function deleteAction()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess($this->__('The baz has been deleted.'));
                $this->_redirect('*/*/');
            ...
            Mage::getSingleton('adminhtml/session')->setBazData($id);
            $this->_redirectReferer();
